            ...
            <div class="navbar navbar-default" style="background-color: transparent; border-color: transparent;">
              <div class="container-fluid">
                ...
                <div class="navbar-header">
                  <a class="navbar-brand" data-toggle="modal" data-target="#login-modal" href="#"><button class="btn btn-inverse"><i class="fa fa-fw fa-sign-in"></i> Sign up</button></a>
                </div>
      ...
      <div class="lock-container"  style="margin-top: 140px">
          ...
          <div class="panel-body" style="margin-top:-20px">
             <?php if (isset($_GET['mssg'])) { ?>
              ...
              <form role="form" data-toggle="validator" name="login_form" id="login_form" action="parse/login.php" method="POST">
                  ...
                  <div class="form-group">
                      ...
                      <div class="form-group">
                        ...
                        <input id="password" class="form-control" type="password" name="password" title="Enter password"  minlength="6" maxlength="20"  placeholder="Password" data-error="Απαιτείται password"/>
                      </div>



            <button class="btn btn-inverse" type="submit" name="login" id="login">Login <i class="fa fa-fw fa-unlock-alt"></i></button>
                  <p><a href="forgot_pass.php" class="forgot-password">Forgot password?</a></p>
...
<?php
 ...
 <?php
                  ...
                  <button class="btn btn-inverse" id="registration" type="submit" name="registration">Sign Up <i class="fa fa-fw fa-sign-in"></i></button>
