...
(function ($) {
    ...
    $(".chat-contacts li").on('click', function () {
        ...
        var context = {user_image: $(this).find('img').attr('src'), session_image: $(this).find('.session img').attr('src'), user: $(this).find('.contact-name').text(), user_message: $(this).find('.message').text(), session_message: $(this).find('.sessionmessage').text(),};
